...
## ★ PROJECT CONTEXT  ← lives in project-particulars.md

Project-specific configuration (name, focus, goals, audience calibration,
domain tags) is in **[[project-particulars.md]]** in this folder. Read that file
at session startup alongside this one. Do not hardcode project details here —
CLAUDE.md is the generic wiki engine; project-particulars.md is the skin.
